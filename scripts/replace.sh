...
then
    ...
    # \<li\>\<a href='https\:\/\/tile\.openstreetmap.de\?server\=tile\&folder\=\'\>Server\: tile, Folder\: \<\/a\>
    # \<\/li\> \<li\>\<a href='https\:\/\/tile\.openstreetmap.de\?server\=tile\&folder\=osmhrb\'\>Server\: tile, Folder\: osmhrb\<\/a\>\<\/li\>
